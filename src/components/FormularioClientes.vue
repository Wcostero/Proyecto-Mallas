<template>
    ...
    methods: {
        async insertarCliente() {
            ...
            this.nuevoCliente = {};
            this.$router.push("/FormularioVentas"); // Redirigir al componente "Clientes.vue" // Limpiar los campos del formulario
        },
        cancelar() {
          this.$router.push("/FormularioVentas"); // Redirigir al componente "Clientes.vue"
        },
        validarFormulario() {
